    ...
    <div className=''>
      <div className='flex header w-full items-center justify-between  absolute z-[100]'>
        <Link to='/'><div className=' font-bold text-white-600 px-4 py-2 text-5xl cursor-pointer' >
            ...
            <Link to='/tvshows/'><div className='text-white font-sm'>Tvshows</div></Link>
            <Link to='/latest/'><div className='text-white font-sm'>latest</div></Link>
           <Link to='mylists'> <div className='text-white font-sm'>mylist</div></Link>
      ...
      <Link to='/login/' > <div> <button className=' text-sm px-6 py-2 mr-4 bg-blue-400 rounded-full cursor-pointer'>Sign In</button></div></Link>
        <Link to='/signup/'><div><button className='text-sm px-6 py-2 mr-4 rounded-full border-red-700 bg-red-400 cursor-pointer'>SignUp</button></div></Link>
        </div>
